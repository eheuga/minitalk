*This project has been created as part of the 42 curriculum by <emheuga>.*
...
You can use [minitalk_tester](https://github.com/MalwarePup/minitalk_tester) to run automated tests on your project.
...
- [Comminicating between processes using signals - CodeVault](https://www.youtube.com/watch?v=PErrlOx3LYE)
- [Bitwise operations in C — Wikipedia](https://en.wikipedia.org/wiki/Bitwise_operations_in_C)
- [C bitwise operators - Bro Code](https://www.youtube.com/watch?v=BGeOwlIGRGI)

### AI usage

AI was used to help structure and format this README and the Makefile.
No AI-generated code was used in the project itself.
